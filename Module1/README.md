...
## Перед настройкой необходимо на *Каждом* устройстве сконфигурировать файлы: <code>/etc/resolv.conf</code>, и после этого в файле <code>/etc/apt/sources.list</code> закоментировать строчку, поставив знак *#*
