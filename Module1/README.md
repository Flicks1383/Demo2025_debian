...
>
> Если возникли проблемы с привелегиями(что странно), то обратите внимание на раздел [Решение проблем](https://github.com/Flicks1383/Demo2025_debian/tree/main?tab=readme-ov-file#решения-проблем)
